...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 14 14:48:33 2018
...
def linear_activation_forward(A_prev,W,b,activation):
    ...
    if activation == 'sigmoid':
        A, activation_cahce = sigmoid(Z)
        #in sigmoid function, activation_cache = Z
    elif activation == 'relu':
        A, activation_cahce = relu(Z)
        #in relu function, activation_cahce = Z
    assert A.shape == (W.shape[0],A_prev.shape[1])
    cache = (linear_cache,activation_cahce)
...
A, linear_activation_cahce = linear_activation_forward(A_prev,W,b,activation = 'sigmoid')
print('With sigmoid: A = ' + str(A))
A, linear_activation_cahce = linear_activation_forward(A_prev,W,b,activation = 'relu')
...
def L_model_backward(AL,Y,caches):
    ...
    for l in reversed(range(L-1)):
        ...
        dA_prev_temp,dW_temp,db_temp = grads['dA' + str(l+2)],grads['dW' + str(l+2)],grads['db' + str(l+2)]
        grads['dA' + str(l+1)] = linear_activation_backward(dA_prev_temp,current_cache,'relu')[0]
...
parameters = update_paramaters(parameters,grads,0.1)
print('W1 = ' + str(parameters['W1']))
print('b1 = ' + str(parameters['b1']))
print('W2 = ' + str(parameters['W2']))
print('b2 = ' + str(parameters['b2']))    
