...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 10 23:42:21 2018
...
#set the size of the hidden layer to 4
def layer_sizes(X, Y):
    """
    Arguments:
...
#tip: if you would like to set the entries of a matrix X to 0 and 1 based on a threshold 
...
print ('Accuracy of hidden size 4: %d' % float((np.dot(Y,predictions.T) + np.dot(1-Y,1-predictions.T))/float(Y.size)*100) + '%')    
